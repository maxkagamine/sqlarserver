...
> [!TIP]
> You can use a [view](https://en.wikipedia.org/wiki/View_(SQL)) to adapt an existing ad hoc table to the sqlar schema (only sqlarserver supports this currently):
> ```sql
